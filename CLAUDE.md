...
`scripts/train_byte_glyph.py` and old constant-LR configs are historical throughput comparisons, not the formal schedule. Protocol and Qwen3-shaped 1.5B scaling are documented in [`docs/07_byte_glyph_pretraining.md`](docs/07_byte_glyph_pretraining.md).
