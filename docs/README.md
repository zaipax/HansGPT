...
### [9. 八卡通信瓶颈实测 (`09_eight_gpu_communication_diagnosis.md`)](09_eight_gpu_communication_diagnosis.md)

2026-09-20的28卡对矩阵、模型等量梯度同步、并发DMA和P2P可用性诊断。
共享PCIe上行的四卡GPU4–7同步约2.449秒，每个桥选一张卡的GPU0/2/4/6约1.359秒；
同时记录当前驱动与平台上的P2P超时边界，区分实测通信收益与尚未验证的训练吞吐。
