...
1. Create a branch with the `codex/` prefix and a worktree under:
   ...
   ```text
   C:\Users\<username>\Desktop\worktree\<project-name>
   ```
...
- Download Unihan, Noto Sans CJK SC, and Chinese Wikipedia directly from the official URLs in `docs/01_glyph_probe_research.md`.
